        ...
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button type="button" className="btn btn-primary mx-2" onClick={props.theme}>Primary</button>
                    ...
                    <button type="button" className="mx-2 btn btn-light">Light</button>
                    <button type="button" className="mx-2 btn btn-dark">Dark</button>
